...
# Tải mô hình LSTM+CNN
lstm_cnn_model = load_model("saved_model/saved_models/lstm_cnn_model.h5")
...
def predict_lstm_cnn(text):
    """
    Hàm dự đoán cảm xúc từ văn bản bằng mô hình LSTM+CNN.
    ...
    # Dự đoán
    prediction = lstm_cnn_model.predict(padded_sequence)
